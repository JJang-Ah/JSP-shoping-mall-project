...
.d1 .t1 th { background: #f1f1f1; color: #333333; text-shadow: 1px 1px 1px gray;}
...
.d2 .t2 th { background: #f1f1f1; color: #333333; text-shadow: 1px 1px 1px gray;}
.center { text-align: center; padding: 5px;}
			...
			<table class="t1">
				...
				<tr>
					...
					<td width="8%" class="left">
						<span class="s2"><a href="../shopContent.jsp?product_id=<%=buy.getProduct_id()%>"><img src="/images/<%=buy.getProduct_image() %>" width="60" height="90"></a></span>
					</td>
