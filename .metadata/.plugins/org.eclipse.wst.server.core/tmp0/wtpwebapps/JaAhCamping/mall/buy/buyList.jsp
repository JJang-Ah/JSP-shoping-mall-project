...
<div class="container">
	...
	<div class="buy_list">
		<div class="d1">
			<span class="s1">자아캠핑 주문내역</span>
		</div>
		<div class="d2">
			<span>01장바구니</span> > <span>02주문서작성/결제</span> > <span><b>03주문완료</b></span>
		</div>
		<hr class="d_line">
			...
			<table class="t1">
				...
				<tr>
					...
					<td width="8%" class="left">
						<a href="buyDetail.jsp?buy_id=<%=buy.getBuy_id()%>"><img src="/images/<%=buy.getProduct_image() %>" width="60" height="90"></a>
					</td>
