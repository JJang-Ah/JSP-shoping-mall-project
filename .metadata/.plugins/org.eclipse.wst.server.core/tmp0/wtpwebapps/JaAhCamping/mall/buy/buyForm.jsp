...
.d3 .t1 th { background: #f3f3f3; color: #111111; text-shadow: 1px 1px 0.5px gray;}
...
<div class="container">
	...
	<div class="buy_form">
		<div class="d1">
			<span class="s1">자아캠핑 주문/결제</span>
		</div>
		<div class="d2">
			<span>01장바구니</span> > <span><b>02주문서작성/결제</b></span> > <span>03주문완료</span>
		</div>
		<hr class="d_line">
			...
			<table class="t1">
				...
				<tr>
					<td width="10%" class="center">
						<a href="../shopping/shopContent.jsp?product_id=<%=cart.getProduct_id()%>"><img src="/images/<%=cart.getProduct_image()%>" width="60" height="90"></a>
					</td>
					<td width="40%" class="left">
						<span class="s1"><a href="../shopContent.jsp?product_id=<%=cart.getProduct_id()%>"><%=cart.getProduct_name() %></a></span><br>
						<span class="s2"><%=cart.getBrand() %></span>
					</td>
