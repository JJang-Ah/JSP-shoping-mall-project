...
/* 중단 - 입력 테이블 */
.info_table { width: 500px; border: 1px solid gray; border-collapse: collapse; margin: 20px auto; border-radius: 20px;}
.info_table tr { height: 65px;}
.info_table th, .info_table td { border: 1px solid black; padding-left: 10px;}
.info_table th { background: lightgray;}
.c_id { background: #ccc;}
...
.info_table span { font-size: 0.8em;}
/* 하단 - 가입, 취소 버튼 */
