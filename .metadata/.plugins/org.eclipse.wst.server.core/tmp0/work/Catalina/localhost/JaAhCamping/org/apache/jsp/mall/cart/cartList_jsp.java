 ...
 * Generated at: 2022-06-12 14:43:01 UTC
...
public final class cartList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write(".d3 input[type=button] { width: 80px; height: 30px; border: none; border-radius: 3px; color: #fff; font-weight: bold; cursor: pointer;}\r\n");
      out.write(".d3 #btn_buy_select { background: #32708d; border: 1px solid #32708d; margin-right: 5px;}\r\n");
      out.write(".d3 #btn_delete_select { background: #99424f; border: 1px solid #99424f;}\r\n");
      out.write("\r\n");
      ...
      out.write(".td4 input[type=\"button\"] { width: 55px; height: 25px; border: 1px solid gray; background: #fff; border-radius: 2px; font-size: 0.8em; cursor: pointer;}\r\n");
      out.write(".td7 input[type=\"button\"] { width: 100px; height: 30px; border: none; border-radius: 3px; color: #fff; font-weight: bold; cursor: pointer;}\r\n");
      out.write("\r\n");
      out.write(".td7 .btn_buy_one { background: #1e94be; border: 1px solid #1e94bd; margin-bottom: 5px;}\r\n");
      out.write(".td7 .btn_delete_one { background: #c84557; border: 1px solid #c84557;}\r\n");
      out.write("\r\n");
      out.write("/* 하단 - d4 */\r\n");
      ...
      out.write(".d4 #btn_buy_select2 { background: #32708d; border: 1px solid #32708d; margin-right: 5px;}\r\n");
      out.write(".d4 #btn_delete_select2 { background: #99424f; border: 1px solid #99424f;}\r\n");
      out.write("\r\n");
      ...
      out.write("			border: 1px solid #196ab3; clear: both; background: #e6f0fa;}\r\n");
      out.write(".t_cart_tot tr { height: 100px;}\r\n");
      out.write(".t_cart_tot td, .t_cart_tot th {}\r\n");
      out.write(".t_cart_tot tr:first-child th:last-of-type{ background: #d4e3f1;}\r\n");
      ...
      out.write(" .d5 #btn_buy_select3 { background: #3a85c8; border: 1px solid #3a85c8;}\r\n");
      out.write(" .d5 #btn_shop { background: #2f9e77; border: 1px solid #3a85c8;}\r\n");
      ...
      out.write("		// 구매 수량 제한 효과(1~100) -> 수정, 1번만 적용됨\r\n");
      out.write("		\r\n");
      ...
      out.write("				location = 'buyForm.jsp?cart_id=' + cart_ids[i].value;\r\n");
      out.write("				\r\n");
      out.write("			})\r\n");
      out.write("		}\r\n");
      out.write("		\r\n");
      ...
      out.write("		// 각 상품별 체크박스 중에서 해제된 것이 있ㄷ면 전체 선택 체크박스를 해제\r\n");
      out.write("		// 각 상품별 체크박스가 모두 체크되었다면 전체 선택 체크박스를 선택\r\n");
      out.write("		let ck_cnt = 0;\r\n");
      out.write("		for(let i=0; i<ck_cart_ones.length; i++) {\r\n");
      out.write("			ck_cart_ones[i].addEventListener(\"change\", function() {\r\n");
      out.write("				if(ck_cart_ones[i].checked == false) {\r\n");
      out.write("					ck_cart_all.checked = false;\r\n");
      out.write("					--ck_count;\r\n");
      out.write("				} else if(ck_cart_ones[i].checked == true){\r\n");
      out.write("					ck_count++;\r\n");
      out.write("				}\r\n");
...
for(CartDTO cart : cartList) { 
      ...
      out.write("			\r\n");
      out.write("			<tr>\r\n");
      out.write("				<td colspan=\"7\">JaAhCamping 배송 상품 총 금액 : <b>");
      ...
      out.write("			<tr>\r\n");
      out.write("				<th>총 상품금액<br><span class=\"s1\">");
      out.print(df.format(p_tot) );
      out.write("</span>원</th>\r\n");
      ...
      out.write("				<th>최종 결제금액<br><span class=\"s4\">");
      out.print(df.format(p_tot) );
      out.write("</span>원</th>\r\n");
      out.write("			</tr>\r\n");
      out.write("			<tr>\r\n");
      ...
      out.write("			<input type=\"button\" value=\"쇼핑계속하기\" id=\"btn_shop\">\r\n");
      out.write("		</div>\r\n");
      out.write("	</div>\r\n");
      out.write("	");
