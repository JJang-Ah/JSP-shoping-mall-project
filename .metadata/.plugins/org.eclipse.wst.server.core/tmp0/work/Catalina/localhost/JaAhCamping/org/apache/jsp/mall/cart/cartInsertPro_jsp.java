 ...
 * Generated at: 2022-06-12 14:28:05 UTC
...
if(memberId == null) {
	...
	out.print("location='../logon/memberLoginForm.jsp';");
      ...
      out.write('\r');
      out.write('\n');
      cart.CartDTO cart = null;
      cart = (cart.CartDTO) _jspx_page_context.getAttribute("cart", javax.servlet.jsp.PageContext.PAGE_SCOPE);
      if (cart == null){
